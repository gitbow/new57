...
public class anotherprogressbar extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.anotherprogressbar");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.anotherprogressbar.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_BusyLoop(cnc.controller2.anotherprogressbar parent) {
this.parent = parent;
}
cnc.controller2.anotherprogressbar parent;
int _myindex = 0;
