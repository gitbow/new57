...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public cnc.controller2.b4xdialog _mdialog = null;
...
_mdialog = new cnc.controller2.b4xdialog();
...
public ResumableSub_Show(cnc.controller2.b4xdatetemplate parent,cnc.controller2.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
cnc.controller2.b4xdatetemplate parent;
