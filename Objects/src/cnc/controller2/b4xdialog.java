...
public class b4xdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.b4xdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.b4xdialog.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(cnc.controller2.b4xdialog parent,Object _text,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
this._text = _text;
this._yes = _yes;
this._no = _no;
...
cnc.controller2.b4xdialog parent;
Object _text;
Object _yes;
Object _no;
Object _cancel;
...
public ResumableSub_ShowCustom(cnc.controller2.b4xdialog parent,anywheresoftware.b4a.objects.B4XViewWrapper _content,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
...
parent.__c.LogImpl("912779544","Warning: dialog shown with zero sized parent.",0);
 if (true) break;
...
public ResumableSub_ShowTemplate(cnc.controller2.b4xdialog parent,Object _dialogtemplate,Object _yes,Object _no,Object _cancel) {
this.parent = parent;
