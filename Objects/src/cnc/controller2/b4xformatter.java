...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(cnc.controller2.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public cnc.controller2.b4xformatter._b4xformatdata  _copyformatdata(cnc.controller2.b4xformatter._b4xformatdata _data) throws Exception{
cnc.controller2.b4xformatter._b4xformatdata _d = null;
...
_d = new cnc.controller2.b4xformatter._b4xformatdata();
...
public cnc.controller2.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
cnc.controller2.b4xformatter._b4xformatdata _d = null;
...
cnc.controller2.b4xformatter._b4xformatdata _data = null;
...
public cnc.controller2.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (cnc.controller2.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public cnc.controller2.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
cnc.controller2.b4xformatter._b4xformatdata _d = null;
...
_d = (cnc.controller2.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public cnc.controller2.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
