...
public class b4ximageview extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.b4ximageview");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.b4ximageview.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("916449563","Invalid resize mode: "+_mresizemode,0);
 break; }
}
;
