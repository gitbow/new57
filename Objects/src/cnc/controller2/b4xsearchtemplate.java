...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public cnc.controller2.b4xfloattextfield _searchfield = null;
...
_searchfield = new cnc.controller2.b4xfloattextfield();
...
__c.LogImpl("922872095","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(cnc.controller2.b4xsearchtemplate parent,cnc.controller2.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
cnc.controller2.b4xsearchtemplate parent;
