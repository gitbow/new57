...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "cnc.controller2.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", cnc.controller2.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public cnc.controller2.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new cnc.controller2.anotherprogressbar();
...
public ResumableSub_Show(cnc.controller2.b4xtimedtemplate parent,cnc.controller2.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
cnc.controller2.b4xtimedtemplate parent;
