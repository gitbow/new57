...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "cnc.controller2", "cnc.controller2.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "cnc.controller2.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
